...
create table bonus(
id_camareira int constraint fk_bonus_cam references camareira(id),
mes_bonus int constraint nn_mes_bonus NOT NULL,
ano_bonus int constraint nn_ano_bonus NOT NULL,
valor_bonus number(6,2),
constraint pk_bonus primary key(id_camareira, mes_bonus,ano_bonus)
);
